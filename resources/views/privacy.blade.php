...
<html>
    ...
    <p>Future vision Co. built the زواج مبارك app as a  free app. This SERVICE is provided by Individual at no cost and is intended
        for use as is.</p>
    ...
    <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions,
        which is accessible at زواج مبارك, unless otherwise defined in this Privacy Policy.</p>
    ...
    <p>We want to inform you that whenever you use our Service, in case of an error in the app we collect
        ...
        may include information such as your devicesâ€™s Internet Protocol (â€œIPâ€) address, device name,
    ...
    <p>Cookies are files with small amount of data that is commonly used an anonymous unique identifier.
        ...
        internal memory.</p>
    <p>>!-- Check if this is true for your app, if unsure, just assume that you do use cookies and modify this next line -->This Services does not uses these â€œcookiesâ€ explicitly. However, the app may use third party code
        and libraries that use â€œcookiesâ€ to collection information and to improve their services. You
